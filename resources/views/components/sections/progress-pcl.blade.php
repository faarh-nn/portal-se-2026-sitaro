            ...
            <div class="pcl-table-header">
                <div class="pcl-table-controls">
                    ...
                    <div class="pcl-table-filter">
                        <label for="pcl-filter-pml" class="pcl-table-filter__label">Filter by PML:</label>
                        <select
                            id="pcl-filter-pml"
                            x-model="pmlFilter"
                ...
                <div class="pcl-table-meta">
                    ...
                    @if($pclLastUpdate)
                        <span class="pcl-table-last-update-wrapper" x-data="{ showTooltip: false }">
                            <span class="pcl-table-last-update" @mouseenter="showTooltip = true" @mouseleave="showTooltip = false">
                                Kondisi {{ $pclLastUpdate->imported_at->setTimezone('Asia/Makassar')->format('j F Y H:i') }} WITA
                            </span>
                            <span class="pcl-table-last-update-tooltip"
                                  x-show="showTooltip"
                                ...
                                <span>Data progress PCL akan di-update secara berkala dua kali sehari setiap pukul 07.00 WITA dan 20.00 WITA</span>
                            </span>
                        </span>
                    @endif
                    <a href="{{ route('pcl.export') }}" class="pcl-table-download" title="Unduh Excel">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
